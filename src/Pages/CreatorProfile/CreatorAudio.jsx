...
const CreatorAudio = ({ audioUrl,prem,page,title,isSub}) => {
  ...
  return (
<div className='creator-audio-div relative' style={{width:'100%'}}>
  {prem && isSub==false?<div className='creator-audio-filter-sheet'>
...
<p>Titre</p>
<p>{title}</p>
<div style={page=='creatorprofile'?{width:'100%',paddingLeft:'0'}:{width:'100%'}} className="audioplayer-div relative">

      <button style={{width:'4rem'}} className="audioplayer-playbtn" onClick={handlePlayPause}>
        {isPlaying ? (
          // Pause SVG
      ...
      <div className="audioplayer-wave" style={{paddingTop:'0.5rem'}} ref={waveformRef} />
