...
const AudioPlayer = ({ audioUrl,prem,text,isSub}) => {
  ...
  return (
    <div id={prem===true?'premdiv':''} style={{borderRadius:'20px',border:'1px solid #1E2141',backdropFilter:'blur(3px)',background:'rgba(30,33,65,1)'}} className="audioplayer-div relative">
{prem && isSub==false?<div style={text?{height:'9rem',border:'1px solid #1E2141 '}:''}  className="locked-post">
{text?<p style={{fontSize:'0.7rem',position:'absolute'}}>{text}</p>:``}
<svg className='locksvg-audioplayer' style={text?{left:'50%',top:'50%',transform:'translate(-50%, 200%)',width:'40',height:'40'}:``} width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<path d="M29.7192 21.6981V19.8113C29.7192 17.1698 27.6438 15.0943 25.0022 15.0943C22.3607 15.0943 20.2853 17.1698 20.2853 19.8113V21.6981C18.6815 21.6981 17.4551 22.9245 17.4551 24.5283V31.1321C17.4551 32.7358 18.6815 33.9622 20.2853 33.9622H29.7192C31.323 33.9622 32.5494 32.7358 32.5494 31.1321V24.5283C32.5494 22.9245 31.323 21.6981 29.7192 21.6981ZM22.1721 19.8113C22.1721 18.2075 23.3985 16.9811 25.0022 16.9811C26.606 16.9811 27.8324 18.2075 27.8324 19.8113V21.6981H22.1721V19.8113ZM25.9456 29.2453C25.9456 29.8113 25.5683 30.1887 25.0022 30.1887C24.4362 30.1887 24.0589 29.8113 24.0589 29.2453V26.4151C24.0589 25.849 24.4362 25.4717 25.0022 25.4717C25.5683 25.4717 25.9456 25.849 25.9456 26.4151V29.2453Z" fill="#0C0E1C"/>
      ...
      <button id={prem==true?"prem-audi":``}  className="audioplayer-playbtn" onClick={handlePlayPause}>
        {isPlaying ? (
          // Pause SVG
      ...
      <div id={prem==true?"prem-audi":`audi`} style={{border:'none',background:'none'}} className="audioplayer-wave" ref={waveformRef} />
    </div>
  );
};
