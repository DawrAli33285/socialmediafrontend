...
import { facebookleAuth } from '../../redux/slices/authenticationslices';
const Facebookauth = () => {
    ...
    const responseFacebook = async(response) => {
        ...
        let res=await dispatch(facebookleAuth(data))
        if(facebookleAuth.rejected.match(res)){
           
       toastr.error(res.payload.error)
        }
        if(facebookleAuth.fulfilled.match(res)){
