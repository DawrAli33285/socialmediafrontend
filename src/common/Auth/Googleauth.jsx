...
import { googleAuth } from '../../redux/slices/authenticationslices';
        ...
        onSuccess: async tokenResponse => {
          ...
          try {
            ...
            if (email_verified) {
              ...
              const sliceResponse = await dispatch(googleAuth(userData));
              if (googleAuth.rejected.match(sliceResponse)) {
                toastr.error(sliceResponse.payload.error);
              }
              if(googleAuth.fulfilled.match(sliceResponse)){
